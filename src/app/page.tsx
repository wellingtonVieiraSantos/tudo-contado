      ...
      <div className='flex flex-col lg:flex-row h-full'>
        <Card className='flex-1 border-none text-center lg:text-left bg-transparent size-full p-3 lg:p-8 grid md:place-content-center md:gap-12'>
          <CardHeader className='gap-3 md:gap-12'>
            <CardTitle className='text-4xl sm:text-7xl 2xl:text-8xl tracking-wide lg:-mt-20'>
              Tome o{' '}
        ...
        <div className='h-full relative flex items-center flex-1'>
          ...
          <Image
            ...
            width={669}
            height={1280}
            className='w-full lg:hidden xl:flex size-180 object-contain absolute lg:-left-35 -top-12 lg:top-20 drop-shadow-lg drop-shadow-foreground-secondary '
          />
        </div>
      </div>
    </div>
